...
## Environments
- Preview: https://main--eds-jeremy--jeremyjbo98.aem.page/
- Live: https://main--eds-jeremy--jeremyjbo98.aem.live/
...
1. Open the `eds-jeremy` directory in your favorite IDE and start coding :)
